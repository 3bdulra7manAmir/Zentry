extension GetStringUtils on String? {
  bool get isLanguage =>
      this != null &&
      RegExp(
        r'^(?!.*\b(English|Arabic|الانجليزية|العربية)\b)([a-zA-Z]+|[\u0600-\u06FF]+)$',
        caseSensitive: false,
      ).hasMatch(this!);

  bool get isCountry {
    final regex = RegExp(
      r'^(Egypt|Morocco|Kuwait|Syrian Arab|United Arab Emirates|Saudi Arabia (SA)|مصر|السعودية|المغرب|الكويت|سوريا|الامارات)$',
      caseSensitive: false,
    );
  ...
  bool get isMode =>
      this != null &&
      RegExp(
        r'^(?!.*\b(Light|Dark|فاتح|داكن)\b)([a-zA-Z]+|[\u0600-\u06FF]+)$',
        caseSensitive: false,
      ).hasMatch(this!);
  ...
  bool get emailEndsWithDomain =>
      RegExp(r'\.[a-zA-Z]{2,}$').hasMatch(this ?? '');
