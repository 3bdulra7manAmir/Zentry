...
class ForgetPasswordEmailTitle extends StatelessWidget
{
  const ForgetPasswordEmailTitle({super.key});
  ...
  Widget build(BuildContext context)
  {
    return Column(
      ...
      [
        ...
        style: AppStyles.textStyle20(fontColor: AppColors.color.kBlack001,),),
        AppSizes.size13.verticalSpace,
        Text(AppLocalizations.of(context).enterEmailAddressAssociated, 
        style: AppStyles.textStyle16(fontColor: AppColors.color.kGreyText002,),),
